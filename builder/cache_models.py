...
from transformers import CLIPImageProcessor, CLIPVisionModelWithProjection, BlipProcessor, BlipForConditionalGeneration
...
def get_diffusion_pipelines():
    ...
    #control net
    # Todo clone only the necessary files
